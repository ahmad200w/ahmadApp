...
const PropertyCard = ({
rooms,children,property,adults,selectedDates,availableRooms
        ...
        <View style={{padding: 10}}>
          <View
            ...
            <Image
              ...
              source={require('../src/assets/foto/iconsBooking/heart-2.png')}
            />
          </View>
          <View
            style={{
            ...
            <Image
              style={{width: 20, height: 20}}
              source={require('../src/assets/foto/iconsBooking/star.png')}
            />
