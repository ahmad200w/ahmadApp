    ...
    <View>
     <Pressable
      ...
      >
        ...
        >
          <Image style={{width:20,height:20}}source={require('../src/assets/foto/iconsBooking/exchange.png')}/>
        ...
        <Image style={{width:20,height:20}}source={require('../src/assets/foto/iconsBooking/sort.png')}/>
          <Text style={{ fontSize: 15, fontWeight: "500", marginLeft: 8 }}>
            Filter
          </Text>
        </Pressable>
        ...
        <Pressable onPress={() => navigation.navigate("Map",{
          ...
          <Image style={{width:20,height:20}}source={require('../src/assets/foto/iconsBooking/maps-and-flags.png')}/>
          <Text style={{ fontSize: 15, fontWeight: "500", marginLeft: 8 }}>
            Map
          </Text>
        </Pressable>
