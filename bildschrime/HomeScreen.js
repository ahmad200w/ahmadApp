  ...
  return (
    <>
          ...
          <View
            ...
            onPress={()=> navigation.navigate('Search')}
              ...
              <Image
                ...
                source={require('../src/assets/foto/iconsBooking/magnifying-glass.png')}
              />
              <TextInput 
            ...
            <Pressable
              ...
              <Image
                style={{width: 25, height: 25}}
                source={require('../src/assets/foto/iconsBooking/calendar.png')}
              />
              <DatePicker
                style={{
                  width: 350,
                ...
                placeholder={'Apr 26, 2023 → Jul 10, 2023'}
                mode={'range'}
              />
            </Pressable>
            {/* Rooms and Guests */}
            <Pressable
              ...
              <Image
                style={{width: 25, height: 25}}
                source={require('../src/assets/foto/iconsBooking/user2.png')}
              />
              <TextInput
      ...
      <BottomModal
        ...
        <ModalContent style={{width: '100%', height: 315}}>
          <View
            style={{
              flexDirection: 'row',
              alignItems: 'center',
